  ...
  return (
    <div className="answers">
      <div className="wrapper">
        <div className="answers-intro-heading">
          <h2>Co można wydobyć z przedstawionych fragmentów?</h2>
        </div>
      </div>
      <div className="answers-specialization">
        ...
        <p>
          ...
          proroctwa, zapowiada niezwykły, pełen grozy spektakl, który ma się
          rozegrać pod osłoną nocy.
        </p>
        <p>
          Wypowiadając słowa: "Co się w duszy komu gra, co kto w swoich widzi
          snach" – ujawnia, że przybyłe zjawy stanowią projekcję wewnętrznych
          konfliktów i dylematów weselnych gości a nie niezależne byty świata
          nadprzyrodzonego.
        </p>
        <br />
        ...
        <h3>Wniosek:</h3>
        <p>
          Wizja senna odsłania podświadome pragnienia bohatera, pokazuje Poetę
          jako człowieka rozdartego wewnętrznie, o niestabilnej, rozchwianej
          osobowości. Z jednej strony – jak romantyczni bohaterowie – marzy mu
          się rola wieszcza, który swoją poezją porywa tłumy do walki i fetuje
          zwycięstwo, z drugiej walczy z własną słabością i niezdecydowaniem. Ma
          świadomość, że tej roli nie potrafi unieść tak ze względu
      ...
      <div className="wrapper">
        <div className="answers-intro-heading">
          <h2>Jak funkcjonalnie odnieść się do całości utworu?</h2>
        </div>
      </div>
      <div className="answers-specialization">
        <h3>
          Wiedza na temat całości utworu niewątpliwie pomoże w interpretacji
          podanej sceny:
        </h3>
        <p>
          Odwołaj się do tego, co wiesz o Poecie na podstawie chociażby I aktu:
          to dekadent porażony niemocą, poddający się schyłkowym nastrojom końca
          wieku. Tkwi w artystycznym marazmie, pisze wiersze skażone smutkiem i
          melancholią, ale marzy mu się poemat o rycerzu w srebrnej zbroi. Nosi
        ...
        <p>
          ...
          zjaw, który ma na celu pogłębić charakterystykę inteligencji z
          przełomu wieków. Podkreśl, że symboliczna wizja staje się w dramacie
          Wyspiańskiego ogólną metodą budowania wizerunków postaci.
        </p>
        <br />
        <h3>
          Konteksty interpretacyjne, czyli do czego warto się odwołać analizując
          podane fragmenty?
        </h3>
        <p>
      ...
      <br />
      <p>
        <em>aleklasa.pl/matura/c266-lektury-klucze-maturalne/wesele-matura</em>
      </p>
    </div>
  );
};
